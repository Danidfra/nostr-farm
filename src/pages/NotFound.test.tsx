...
/**
 * The app is deployed under a base path (`/nostr-farm/` on GitHub Pages). A
 * raw `href="/"` escaped to the domain root; the link must resolve through
 * the router's basename instead.
 */
describe('NotFound', () => {
